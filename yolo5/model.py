...
def get_yolo5_train_model(model_type, anchors, num_classes, from_coco=False, weights_path=None, freeze_level=1, optimizer=Adam(lr=1e-3, decay=0), label_smoothing=0, elim_grid_sense=True, model_pruning=False, pruning_end_step=10000):
    ...
    if weights_path and from_coco:
        ...
        model_body.load_weights(f'weights/pretrained_coco_{model_type}', by_name=True, skip_mismatch=True)
        print("Success!")
