...
default_config = {
        "model_type": 'tiny_yolo3_darknet', #'scaled_yolo4_csp_darknet', # 'yolo3_mobilenet_lite'
        "weights_path": os.path.join('weights', 'yolov3-tiny.h5'), #os.path.join('weights', 'scaled-yolov4-csp.h5'), # os.path.join('weights', 'yolo3_mobilenet_lite_416_coco.h5')
        "pruning_model": False,
        "anchors_path": os.path.join('configs', 'tiny_yolo3_anchors.txt'), #os.path.join('configs', 'yolo4_anchors.txt'), #os.path.join('configs', 'yolo3_anchors.txt')
