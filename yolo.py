...
default_config = {
        "model_type": 'yolo3_mobilenet_lite', #'scaled_yolo4_csp_darknet',
        "weights_path": os.path.join('weights', 'yolo3_mobilenet_lite_416_coco.h5'), # os.path.join('weights', 'scaled-yolov4-csp.h5'),
        "pruning_model": False,
        "anchors_path": os.path.join('configs', 'yolo3_anchors.txt'), #os.path.join('configs', 'yolo4_anchors.txt')
