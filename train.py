...
def main(args):
    ...
    if args.gpu_num >= 2:
        ...
        with strategy.scope():
            ...
            model = get_train_model(args.model_type, anchors, num_classes, from_coco=args.from_coco, weights_path=args.weights_path, freeze_level=freeze_level, optimizer=optimizer, label_smoothing=args.label_smoothing, elim_grid_sense=args.elim_grid_sense, model_pruning=args.model_pruning, pruning_end_step=pruning_end_step)
